...
//sign in or edit
// const globalUserID = document.querySelector(".username-field").value;
// const globalPass = document.querySelector(".password-field").value;
...
//todo: AUTOGENERATED FUNCTION.. (HAVE TO IMPLEMENT THIS MYSELF)
// if(editValidate(globalUserID, globalPass)){
//     editButton.addEventListener('edit-button', function(){
...
//shows an add button after edit button is clicked and userID and pass is correct.
function showAddButton(){
    if(editValidate()){
        document.getElementById('show-add-button').value = <button id = "add-button" onclick = "editValidate();">Add Blog</button>;
    }
}
